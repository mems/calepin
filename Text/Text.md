...
- [Character Set · reinderien/mimic Wiki](https://github.com/reinderien/mimic/wiki/Character-Set) - Character resemblance
- [Unicode Toys](http://qaz.wtf/u/)
- [Online Text Obfuscator](http://obfuscator.uo1.net/)
...
- [Exclusive: The complete Windows Phone emoji list | Windows Central](http://www.windowscentral.com/exclusive-complete-windows-phone-emoji-list)
- [Find relevant emoji from text on the command-line](https://github.com/sindresorhus/emoj) - "i love unicorns" gives "🦄  🎠  🐴  🐎  ❤  ✨  🌈"

Other:

- [Twitter Emoji for Everyone](https://github.com/twitter/twemoji)
- Difference between implementations: [Investigating the Potential for Miscommunication Using Emoji | GroupLens](https://grouplens.org/blog/investigating-the-potential-for-miscommunication-using-emoji/) and [“Blissfully happy” or “ready to fight”: Varying Interpretations of Emoji](https://grouplens.org/site-content/uploads/Emoji_Interpretation_Paper.pdf)
- [EmojiSymbols Font](http://emojisymbols.com/)
...
- Native (OSX, iOS, Windows 7 Segoe UI symbol, WP)
- Facebook (chat, status, pages, comments)
- Skype, ...
- Emoji cheat sheet

Facebook emoji reference chart:

![Facebook emoji reference chart](emojis-list-insert-facebook-cryptlife.jpg)
