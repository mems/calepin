Add a uncompressed file without attributes then file `zip -0 -X doc.odt mimetype; zip -r doc.odt * -x mimetype` (`mimetype` file contains the string "application/vnd.oasis.opendocument.text")
